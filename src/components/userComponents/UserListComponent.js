...
function UserListComponent({ data , setLimit, activeTab}) {
  ...
  return (
    <div className="bg-[white] px-5 py-3">
      ...
      {data && activeTab === 'Active Individual' && <ActiveTableComponent name="host" data={data} columns={columns} link="host" />}

      {data && activeTab === 'Pending Individual' && <PendingTableComponent name="host" data={data} link="host" />}
    </div>
  );
}
